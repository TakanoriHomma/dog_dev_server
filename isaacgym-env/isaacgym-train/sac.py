...
from util.utils_sac import soft_update, hard_update
from model.SACNN import GaussianPolicy, QNetwork, DeterministicPolicy
...
class SAC(object):
    ...
    def save_checkpoint(self, env_name, suffix="", ckpt_path=None):
        if not os.path.exists("data/sac/checkpoints/"):
            os.makedirs("data/sac/checkpoints/")
        if ckpt_path is None:
            ckpt_path = "data/sac/checkpoints/sac_checkpoint_{}_{}".format(
                env_name, suffix
            )
